...
_Sub0 = L{|s| L{|n| L{|m| $_0IF[_IsZero[m]][n][ L{|g| s[_Sub1[n]][_Sub1[m]][g]} ]}}}
$_0Sub = $_Y[_Sub0]

_Mul0 = L{|s| L{|n| L{|m| $_0IF[_IsZero[m]][$_00][ L{|g| $_0Add[n][ s[n][_Sub1[m]] ][g] } ]}}}
$_0Mul = $_Y[_Mul0]
...
$_0LT = L{|n| L{|m| $_0IF[$_0NOT[$_0EQ[n][m]]][ $_0IF[_IsZero[_Sub1[_CMP[n][m]]]][$_0TRUE][$_0FALSE] ][$_0FALSE] }}
