...
_LEN0 = L{|s| L{|l| $_1IF[$_IsNULL[l]][$_0][ L{|g| $_1Add1[s[$_SND[l]]][g]} ]}}
$_LEN = $_Y[_LEN0]

$_TAIL = L{|n| $_T[n][$_NULL]}
$_HEAD = $_NULL

_LIST0 = L{|s| L{|l| L{|n| $_1IF[$_IsNULL[n]][l][ L{|g| s[$_T[n][l]][g]} ]}}}
$_LIST = $_Y[_LIST0]
$_LIST_APP = $_LIST

_LIST_AT0 = L{|s| L{|l| L{|n| L{|m| $_1IF[$_1EQ[n][m]][$_FST[l]][ L{|g| s[$_SND[l]][$_Sub1[n]][m][g]} ]}}}}
_LIST_AT1 = $_Y[_LIST_AT0]
$_LIST_AT = L{|l| L{|n| $_1IF[$_IsNUM[n]][ L{|g| _LIST_AT1[l][$_LEN[l]][$_1Add1[n]][g]} ][$_NULL]}}
...
_LIST_MAP0 = L{|s| L{|l| L{|f| $_1IF[$_IsNULL[l]][$_NULL][ L{|g| $_T[f[$_FST[l]]][s[$_SND[l]][f]][g]} ]}}}
$_LIST_MAP = $_Y[_LIST_MAP0]

_LIST_IDX0 = L{|s| L{|l| L{|n| L{|f|
  $_1IF[$_IsNULL[l]][$_NULL][
      $_1IF[f[$_FST[l]]][n][ L{|g| s[$_SND[l]][$_Sub1[n]][f][g]} ]
  ]
}}}}
...
_LIST_CMP0 = L{|s| L{|n| L{|m| L{|f|
  $_1IF[$_OR[$_IsNULL[n]][$_IsNULL[n]]][
    ...
    $_1IF[f[$_FST[n]][$_FST[m]]][ L{|g| s[$_SND[n]][$_SND[m]][f][g]} ][$_FALSE]
  ]
}}}}
$_LIST_CMP = $_Y[_LIST_CMP0]

# >> TYPE 5 : STRING
$_STR = L{|n| $_1IF[$_IsTUPLE[n]][$_0C[$_05][n]][$_NULL]}
$_IsSTR = L{|n| $_0IF[$_0EQ[$_05][$_TYPE_OF[n]]][$_TRUE][$_FALSE]}

$_STR_EQ = L{|n| L{|m|
  $_1IF[$_AND[$_IsSTR[n]][$_IsSTR[m]]][
