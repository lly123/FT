...
$_TYPE_EQ = L{|n| L{|m| $_0IF[$_0EQ[$_TYPE_OF[n]][$_TYPE_OF[m]]][$_TRUE][$_FALSE]}}
...
$_Add1 = L{|n| $_NUM[$_0Add1[_VAL[n]]]}
$_Add = L{|n| L{|m| $_0IF[$_TYPE_EQ[n][m]][$_NUM[$_0Add[_VAL[n]][_VAL[m]]]][$_NULL]}}
